...
window.onload = function() {
        ...
        function timeline() {
            ...
            masterTimeline.add(TweenLite.to("#logo", 0.5, {width: 49}), delay);
            delay+=3;
            ...
            masterTimeline.add(TweenLite.to("#fr3-txt1", 0.5, {opacity: 1}), delay += 0.25);
            
            delay+= 0.5;
            /*masterTimeline.add(TweenLite.to("#fr3-txt1", 0.25, {opacity: 0}), delay);
            masterTimeline.add(TweenLite.to("#fr3-txt2", 0.5, {opacity: 1}), delay += 0.25);*/
