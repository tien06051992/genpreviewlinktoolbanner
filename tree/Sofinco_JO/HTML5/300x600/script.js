...
window.onload = function() {
        ...
        function timeline() {
            ...
            masterTimeline.add(TweenLite.to("#arrow1", 1, {height: 310}), delay);
            delay+=0.25;

            masterTimeline.add(TweenLite.to("#arrow1", 1, { width: 300 }), delay);
            ...
            masterTimeline.add(TweenLite.to("#logo", 0.5, {width: 107}), delay);
            delay+=4;
