...
window.onload = function() {
        ...
        function timeline() {
            ...
            delay+=0.5;
            masterTimeline.add(TweenLite.to("#fr1-txt1", 1, {opacity: 1}), delay);
            masterTimeline.add(TweenLite.to("#arrow1", 1, {height: 300}), delay);
            delay+=0.25;

            masterTimeline.add(TweenLite.to("#arrow1", 0.5, { width: "100%" }), delay);
            ...
            masterTimeline.add(TweenLite.to("#logo", 0.5, {width: 72, marginLeft: -36, left: '50%'}), delay);
            delay+=4;
			...
			delay+=1;
			masterTimeline.add(TweenLite.to("#arrow2", 0.5, {
				height: 115
			}), delay);
            masterTimeline.add(TweenLite.to("#arrow2", 0.5, {
                width: 22, height: 127
